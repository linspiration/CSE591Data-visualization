var dashboard4 = (function () {
    ...
    function createSummaryChart() {
        ...
        var xAxis = '2012', yAxis = '20121';
        var xAxisOptions = ["1960","1965", "1970","1975", "1980", "1985","1990","1995", "2000","2005", "2012"]
        var yAxisOptions = ["19601","19651", "19701","19751", "19801", "19851","19901","19951", "20001","20051", "20121"]
...
//                });
        ...
        d3.select('svg g.chart')
            ...
            .text("Mobile cellular subscription(per 100 people)");

        d3.select('svg g.chart')
            .append('text')
            .attr('transform', 'translate(-60, 330)rotate(-90)')
            .attr({'id': 'yLabel', 'text-anchor': 'middle'})
            .text("Internet users (per 100 people)").attr("style", style = "stroke-width:10");
        ...
        d3.select('svg g.chart')
            ...
            .attr('fill', function(d, i) {return randomColor(i);})
        ...
        function updateChart(init) {
            ...
            d3.select('svg g.chart')
                ...
                .attr('r', function(d) {
                    return isNaN(d[xAxis]) || isNaN(d[yAxis]) ? 0 : 20;
                });
...
//                .text(descriptions[xAxis]);
    ...
    function render() {
        var html =
            '<h1 align="center">Infrastructure Level</h1>' +
                ' <div id="x-axis-menu">' +'&nbsp'+
                '</div>' +
            '<div id="chart">' +
                '</div>'
